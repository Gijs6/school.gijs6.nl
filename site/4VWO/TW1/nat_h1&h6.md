...
Een afwijkend verband is het **lineaire verband** met de formule $a = c \cdot b + d$. Deze lijn gaat dus niet door de oorsprong (als $d \neq 0$). Om de constante te bepalen neem je 2 punten op de grafiek en voer je de berekening $\frac{\Delta y}{\Delta x}$ uit.

Met behulp van een **coördinatentransformatie** kun je bekijken met welk verband je te maken hebt. Je weet dat een rechte lijn door de oorsprong altijd een evenredig verband is. Om een rechte lijn te krijgen uit de andere verbanden moet je dus een formule krijgen in de vorm $a = c \cdot b$. Bij een kwadratisch verband is b dus $b^2$, en bij een omgekeerd kwadratisch verband is b dus $\frac{1}{b^2}$. Een coördinatentransformatie is dus eigenlijk een verandering van de grootheden langs de assen, om zo een rechte lijn te krijgen. In de tabel zie je in de tweede kolom deze formules in de vormen voor de coördinatentransformatie.

De constante van een formule kun je bepalen door op 1 punt de grafiek af te lezen en deze gegevens vervolgens in de bijbehorende formule zetten. Als je bij een wortelverband dus $a = 10$ en $b = 30$ afleest, weet je dat $c = \frac{a}{\sqrt{b}} = \frac{10}{\sqrt{30}} = 1{,}8$.
