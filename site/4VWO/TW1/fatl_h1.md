...
De volgende regels gelden voor de voltooid deelwoorden van regelmatige werkwoorden: *\-er* $\Rightarrow$ *\-é*, *\-re* $\Rightarrow$ *\-u* en *\-ir* $\Rightarrow$ *\-i*.  
...
*avoir* $\Rightarrow$ *aur-*; *vivre* $\Rightarrow$ *vivr-*  
*être* $\Rightarrow$ *ser-*; *faire* $\Rightarrow$ *fer-*
...
*Victor est plus sportif que Thomas.* $\Rightarrow$ Victor is sportiever dan Thomas.

Je moet het bijvoeglijk naamwoord aanpassen aan het onderwerp.  
*Christine est moins intelligente que Raoul.* $\Rightarrow$ Christine is minder intelligent dan Raoul.
...
*C'est la plus petite maison du monde.* $\Rightarrow$ Dat is het kleinste huis ter wereld.
...
*Il est le garçon le plus sportif.* $\Rightarrow$ Hij is de meest sportieve jongen.
