...
Als je de molaire massa van een molecuul wil berekenen (bijv. als deze niet in Binas 98 staat), tel je dus de molaire massa's van alle lossen atomen bij elkaar op. De molaire massa van ethanol ($\ce{C2H6O}$) is dus $M = 2 \cdot 12{,}01 + 6 \cdot 1{,}008 + 1 \cdot 16{,}00 = 46{,}068~\mathrm{g/mol}$.  
Met de molaire massa kun je ook het massapercentage berekenen van een bepaald element binnen een molecuul.

![][image4]

Het massapercentage natrium in natriumthiosulfaat ($\ce{Na2S2O3}$) bereken je dus als volgt: $M_{\ce{Na2S2O3}} = 2 \cdot 22{,}99 + 2 \cdot 32{,}06 + 3 \cdot 16{,}00 = 158{,}1~\mathrm{u}$. $M_{\ce{Na}} = 2 \cdot 22{,}99 = 45{,}98~\mathrm{u}$. $m\% = \frac{45{,}98}{158{,}1} \cdot 100\% = 29{,}1\%$.  
...
Voorbeeld: Hoeveel gram zuurstof ontstaat bij de volledige ontleding van $10{,}0~\mathrm{g}$ water? Gebruik de reactievergelijking: $\ce{2 H2O -> 2 H2 + O2}$
Binas 99 geeft $M_{\ce{H2O}} = 18{,}015~\mathrm{g/mol}$
