...
Alle soorten worden ingedeeld op basis van verwantschap met andere soorten (**taxonomie**). De taxonomie plaatst organisme in steeds grotere groepen (**taxa**): organismen -> soorten -> geslachten -> families -> orden -> klassen -> afdelingen -> rijken -> domeinen. Hoe minder verwant 2 organismen aan elkaar zijn, hoe minder taxa ze delen.
